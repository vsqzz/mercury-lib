...
local Library = {
	Themes = {
		...
		Aqua = {
			...
			Secondary = Color3.fromRGB(55, 63, 63),
...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("FuriousSettings.json") then
			writefile("FuriousSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("FuriousSettings.json"))
	...
	options = self:set_defaults({
		...
		Link = "https://github.com/deeeity/Furious-lib"
	}, options)

	if getgenv and getgenv().FuriousUI then
		getgenv():FuriousUI()
		getgenv().FuriousUI = nil
	end
	...
	creditsTab:credit{Name = "Repository", Description = "UI Library Repository", Github="https://github.com/deeeity/Furious-lib/blob/master/src.lua"}
